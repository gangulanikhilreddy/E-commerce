...
class Slideshow  extends React.Component {
    ...
    return (
      <Slide className="slide" {...properties}>
        ...
        <img src='images/background1.jpg' alt="pic here" height="380px" width="1600px" ></img>
        </div>
        <div className="each-slide">
        <img src='images/background2.jpg' alt="pic here" height="380px" width="1600px" ></img>
        </div>
        <div className="each-slide">
        <img src='images/background3.jpg' alt="pic here" height="380px" width="1600px" ></img>
        </div>
        <div className="each-slide">
